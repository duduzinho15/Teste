...
# URLs válidas para testes de validação
VALID_URLS = {
    "awin": [
    ...
    "amazon": [
        "https://www.amazon.com.br/Apple-iPhone-13-256-GB-das-estrelas/dp/B09T4WC9GN?tag=garimpeirogee-20",
        "https://amzn.to/3HAIr8w",
        "https://www.amazon.com.br/Notebook-ASUS-Gaming-KeepOS-RTX3050/dp/B0D63QVQ9K?tag=garimpeirogee-20"
    ],
    "mercadolivre": [
    ...
    "aliexpress": [
        ...
        "https://pt.aliexpress.com/item/1005007488115262.html"
    ],
    "rakuten": [
        "https://www.rakuten.com.br/shop/loja/produto/123",
        "https://www.rakuten.com.br/shop/outra-loja/produto/456"
    ]
}

# Exemplos específicos para testes de bloqueio
SHOPEE_EXAMPLES = {
    "blocked": [
        "https://shopee.com.br/cat.12345",  # Categoria inválida
        "https://shopee.com.br/invalid/path"  # Caminho inválido
    ]
}
...
MAGALU_EXAMPLES = {
    ...
    "invalid": [
        "https://www.magazineluiza.com.br/produto/123",  # Sem vitrine
        "https://magazineluiza.com.br/invalid/path"  # Caminho inválido
    ]
}
...
AWIN_EXAMPLES = {
    ...
    "invalid": [
        "https://www.awin1.com/invalid/path",
        "https://awin.com/produto-sem-parametros"
    ]
}
...
MERCADOLIVRE_EXAMPLES = {
    ...
    "invalid": [
        ...
        "https://mercadolivre.com.br/social/garimpeirogeek?..."
    ],
    "blocked": [
        "https://www.mercadolivre.com.br/social/garimpeirogeek?...",
        "https://mercadolivre.com.br/categoria/bloqueada"
    ]
}
...
AMAZON_EXAMPLES = {
    ...
    "invalid": [
        "https://www.amazon.com.br/invalid/path",
...
ALIEXPRESS_EXAMPLES = {
    ...
    "invalid": [
        ...
        "https://aliexpress.com.br/produto-sem-id"
    ]
}
...
RAKUTEN_EXAMPLES = {
    ...
    "invalid": [
        "https://www.rakuten.com.br/invalid/path",
        "https://rakuten.com/produto-sem-loja"
    ]
}

# URLs inválidas para testes de rejeição
INVALID_URLS = {
    "awin_invalid_domain": "https://www.lojainvalida.com.br/produto/123",
    "ml_invalid_domain": "https://www.mercadolivre.com/invalid/path",
    "shopee_category": "https://shopee.com.br/cat.12345",
    "magalu_no_vitrine": "https://www.magazineluiza.com.br/produto/123",
    "amazon_no_asin": "https://www.amazon.com.br/invalid/path",
    "aliexpress_invalid": "https://pt.aliexpress.com/invalid/path",
}
